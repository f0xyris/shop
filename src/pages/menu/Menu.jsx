...
function Menu() {
  return (
    <div className="content menu-wrapper w-[100vw] lg:w-[70vw] xl:w-[68vw]">
      <h1>Menu</h1>
      <div className="menu">
        <MenuItem title="rolls" image={roll} />
        <MenuItem title="sushi" image={sushi} />
        <MenuItem title="sets" image={set} />
        <MenuItem title="snacks" image={burr} />
        <MenuItem title="drinks" image={drinks} />
        <MenuItem title="sauces" image={sia} />
      </div>
    </div>
  );
}
