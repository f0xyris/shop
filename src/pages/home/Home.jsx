...
function Home() {
  ...
  return (
    <div className="home">
      <div className="home__content content w-[100vw] lg:w-[70vw] xl:w-[68vw] md:pt-20!">
        <Slide />
        ...
        <div className="home__topPos">
          <h1>Top positions</h1>
          <p>
            The Ninja Sushi assortment includes rolls, sushi, sets and drinks
            for every taste. We recommend you definitely try the top positions
            of our menu!
          </p>
          <ProductItems collectionName="rolls" activeSlider button />
          <ProductItems collectionName="sushi" activeSlider button />
          <ProductItems collectionName="sets" activeSlider button />
          <ProductItems collectionName="snacks" activeSlider button />
          <ProductItems collectionName="drinks" activeSlider button />
        </div>
      </div>
    </div>
  );
